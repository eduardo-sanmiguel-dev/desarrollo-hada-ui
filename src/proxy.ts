...
export const config = {
  matcher: [
    "/",
    "/((?!_next|favicon.ico|auth|areas|workplaces|employees|projects|reasons-for-request|personnel-requisitions|position-configurations|nonconformance-reports|nonconformance-evidences|.*\\..*).*)",
  ],
};
