...
export const config = {
  matcher: [
    "/",
    "/((?!_next|favicon.ico|auth|areas|workplaces|employees|users|projects|reasons-for-request|personnel-requisitions|position-configurations|nonconformance-reports|nonconformance-evidences|.*\\..*).*)",
  ],
};
